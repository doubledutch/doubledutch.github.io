...
slug: web-views
date: 2017-09-23
title: 'Web View Sections in a DoubleDutch event app'
description: 'Custom pages with user and event context'
published: true
author: 'Adam Liechty'
banner: './banner.png'
redirects:
...
[DDEventsSDK.js](https://github.com/doubledutch/sdk/blob/master/DDEventsSDK.js) script, and your
Javascript in the page can query for event data.
